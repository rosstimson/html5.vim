  ...
  if a:findstart
	...
	if shortcontext =~ '\.$'
		...
		let arraymeth = ['concat', 'join', 'pop', 'push', 'reverse', 'shift',
					...
					\ 'watch', 'unwatch', 'indexOf', 'lastIndexOf', 'every', 'filter', 'forEach', 'map', 'some', 'reduce', 'reduceRight', 'isArray']
		...
		let datemeth = ['getDate', 'getDay', 'getFullYear', 'getHours', 'getMilliseconds',
					...
					\ 'toSource', 'toString', 'toUTCString', 'UTC', 'valueOf', 'watch', 'unwatch', 'toJSON']
		...
		let funcmeth = ['apply', 'bind', 'call', 'toSource', 'toString', 'valueOf', 'isGenerator']
		...
		let objemeth = ['eval', 'toSource', 'toString', 'unwatch', 'watch', 'valueOf', 'getPrototypeOf', 'create', 'defineProperty', 'defineProperties', 'getOwnPropertyDescriptor', 'keys', 'getOwnPropertyNames', 'preventExtensions', 'isExtensible', 'seal', 'isSealed', 'freeze', 'isFrozen', 'hasOwnProperty', 'isPrototypeOf', 'propertyIsEnumerable', 'toLocaleString']
		...
		let strimeth = ['anchor', 'big', 'blink', 'bold', 'charAt', 'charCodeAt', 'concat',
					...
					\ 'toSource', 'toString', 'toUpperCase', 'watch', 'unwatch', 'trim', 'trimLeft', 'trimRight']
